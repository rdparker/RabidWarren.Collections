...
namespace RabidWarren.Collections.Generic
{
    ...
    public class Multimap<TKey, TValue> : IMultimap<TKey, TValue>
    {
        ...
        /// <para>The dictionary is designed to provide efficient lookup of a relatively small number of
        /// items per key.  The original use case had class types as the key and property metadata as the
        ...
        /// <para>So, the the keys are maintained in a dictionary and their values are stored in a simple
        ...
        ///
        /// <exception cref="ArgumentNullException">Passes when <paramref name="key"/> is <c>null</c>.</exception>
        ...
        /// <summary>
        /// Removes all elements with the specified key from the map.
        /// </summary>
        ...
        /// <param name="values">[out] When this method returns, the values associated with the specified
        /// key, if they key is found; otherwise, at empty collection is returned. The parameter should
        /// be passed uninitialized. It will not be updated, it will be replaced.</param>
        /// <returns>
        ...
        /// the elements copied from map. The
        ...
        /// <exception cref="ArgumentException">The number of elements in the source map is greater than
        ...
        /// <summary>
        /// Removes the first occurrence of the specific object from the map.
        /// </summary>
