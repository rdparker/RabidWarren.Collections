...
namespace RabidWarren.Collections.Generic
{
        ...
        IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable
    {
        ...
        /// <see cref="Generic.IMultimap{TKey, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the <see cref="Generic.IMultimap{TKey, TValue}"/> contains an element with
        /// the specified key.
        /// </summary>
        /// <param name="key">The key to locate in the
        /// <see cref="Generic.IMultimap{TKey, TValue}"/>.</param>
        /// <returns>
        /// <c>true</c> if the <see cref="Generic.IMultimap{TKey, TValue}"/> contains an element with the
        ...
        /// not found in the original <see cref="Generic.IMultimap{TKey, TValue}"/>.
        /// </returns>
        ///
        /// <exception cref="ArgumentNullException"><paramref name="key"/> is <c>null</c>.</exception>
        ...
        /// also returns <c>false</c> if the <paramref name="key"/> was not found in the original
        /// <see cref="Generic.IMultimap{TKey, TValue}"/>.
        /// </returns>
        ...
        /// <param name="values">When this method returns, the values associated with the specified key,
        /// if they key is found; otherwise, at empty collection is returned. The parameter should be
        /// passed uninitialized. It will not be updated, it will be replaced.</param>
        /// <returns>
        /// <c>true</c> if the <see cref="Generic.IMultimap{TKey, TValue}"/> object contains any elements
